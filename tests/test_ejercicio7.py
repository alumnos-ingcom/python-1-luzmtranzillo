...
def test_sexadecimal_a_decimal():
    ...
    assert signo(horas)==1, 'Debe ingresar un valor positivo.'
    assert signo(minutos)==1, 'Debe ingresar un valor positivo.'
    assert signo(segundos)==1, 'Debe ingresar un valor positivo.'
...
def test_decimal_a_sexadecimal():
    ...
    assert signo(numero)==1, 'Debe ingresar un valor para número positivo.'
